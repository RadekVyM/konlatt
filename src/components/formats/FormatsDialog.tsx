        ...
        formats: [
            {
                ...
                isOutput: true,
                isInput: true,
                example: convertConceptsToJson(CONTEXT.objects, CONTEXT.attributes, CONCEPTS, CONTEXT.name ?? "", LATTICE.superconceptsRelation).lines,
            },
            {
                ...KONLATT_XML,
                isOutput: true,
                isInput: true,
                example: convertToXml(CONTEXT.objects, CONTEXT.attributes, CONCEPTS, CONTEXT.name ?? "", LATTICE.superconceptsRelation).lines,
            },
        ],
    },
];
