...
export function pushConcept(
    ...
    pushArray(lines, concept.objects, "objects", conceptBodyIndentation, true, context ? (object) => stringTransformer(context.objects[object]) : defaultTransformer, collapseRegions);
    pushArray(lines, concept.attributes, "attributes", conceptBodyIndentation, false, context ? (attribute) => stringTransformer(context.attributes[attribute]) : defaultTransformer, collapseRegions);
